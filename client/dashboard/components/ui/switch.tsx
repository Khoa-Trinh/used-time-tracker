  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="bg-background dark:data-unchecked:bg-foreground dark:data-checked:bg-primary-foreground rounded-full group-data-[size=default]/switch:size-4 group-data-[size=sm]/switch:size-3 group-data-[size=default]/switch:data-checked:translate-x-[calc(150%-2px)] group-data-[size=sm]/switch:data-checked:translate-x-[calc(150%-2px)] group-data-[size=default]/switch:data-unchecked:translate-x-[2px] group-data-[size=sm]/switch:data-unchecked:translate-x-[2px] pointer-events-none block ring-0 transition-transform"
      />
    </SwitchPrimitive.Root>
  )
}
